...
public class HalSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case HalPackage.SPECIFIC_DEVICE: {
			SpecificDevice specificDevice = (SpecificDevice) theEObject;
			T result = caseSpecificDevice(specificDevice);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case HalPackage.DEVICE_EVENT: {
			DeviceEvent deviceEvent = (DeviceEvent) theEObject;
			T result = caseDeviceEvent(deviceEvent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case HalPackage.CONDITION_ITEM: {
			ConditionItem conditionItem = (ConditionItem) theEObject;
			T result = caseConditionItem(conditionItem);
			if (result == null)
				result = casePreCondition(conditionItem);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case HalPackage.BOOLEAN_EXPRESSION: {
			...
			if (result == null)
				result = casePreCondition(booleanExpression);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case HalPackage.SENSOR_EVENT: {
			...
			if (result == null)
				result = caseDeviceEvent(sensorEvent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case HalPackage.COMMAND_EVENT: {
			...
			if (result == null)
				result = caseDeviceEvent(commandEvent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case HalPackage.AUTOMATION_RULE_EVENT: {
			AutomationRuleEvent automationRuleEvent = (AutomationRuleEvent) theEObject;
			T result = caseAutomationRuleEvent(automationRuleEvent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Specific Device</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Specific Device</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSpecificDevice(SpecificDevice object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Device Event</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Device Event</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDeviceEvent(DeviceEvent object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Condition Item</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Condition Item</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseConditionItem(ConditionItem object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Automation Rule Event</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Automation Rule Event</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAutomationRuleEvent(AutomationRuleEvent object) {
		return null;
	}
