 ...
 * </p>
 * <ul>
 *   <li>{@link ca.mcgill.emf.hal.impl.RoomImpl#getName <em>Name</em>}</li>
 *   <li>{@link ca.mcgill.emf.hal.impl.RoomImpl#getSpecificdevice <em>Specificdevice</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoomImpl extends MinimalEObjectImpl.Container implements Room {
	...
	/**
	 * The cached value of the '{@link #getSpecificdevice() <em>Specificdevice</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList<SpecificDevice> specificdevice;
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case HalPackage.ROOM__SPECIFICDEVICE:
			return ((InternalEList<?>) getSpecificdevice()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case HalPackage.ROOM__NAME:
			...
			return;
		case HalPackage.ROOM__SPECIFICDEVICE:
			getSpecificdevice().clear();
			getSpecificdevice().addAll((Collection<? extends SpecificDevice>) newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case HalPackage.ROOM__SPECIFICDEVICE:
			return specificdevice != null && !specificdevice.isEmpty();
		}
