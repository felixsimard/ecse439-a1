 ...
 * </p>
 * <ul>
 *   <li>{@link ca.mcgill.emf.hal.impl.OwnerImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OwnerImpl extends MinimalEObjectImpl.Container implements Owner {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HalPackage.OWNER__NAME, oldName, name));
	}
