 ...
 * </p>
 * <ul>
 *   <li>{@link ca.mcgill.emf.hal.impl.ActuatorImpl#getCommand <em>Command</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActuatorImpl extends DeviceImpl implements Actuator {
	...
	public EList<Command> getCommand() {
		if (command == null) {
			command = new EObjectContainmentEList<Command>(Command.class, this, HalPackage.ACTUATOR__COMMAND);
		}
		return command;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case HalPackage.ACTUATOR__COMMAND:
